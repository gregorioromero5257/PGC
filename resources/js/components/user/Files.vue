<template>
    <div class="files mb-3 mt-3 col-md-12">
      <div class="margin-profile">
        <p class="form-control-three mt-2 d-inline-block ">Archivos</p>
        <a href="#" class="btn btn-outline-blue float-right" @click="newModal" v-if="$gate.activeUser().role_id == 1 || $gate.activeUser().role_id == 2 || $gate.activeUser().role_id == 3">
            <i class="fas fa-plus mr-1"></i>
            Agregar archivo
        </a>
        <div class="table-responsive" v-if="$props.user.files && $props.user.files.length">
            <table class="table">
