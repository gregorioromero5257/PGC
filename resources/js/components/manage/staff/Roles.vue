                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr v-for="role in roles" :key="role.id">
                                <td>{{ role.name }}</td>
                                <td class="text-center">{{ role.created_at | myDate }}</td>
                                <td class="text-center">
                                    <a class="text-dark" @click="editModal(role)">
                                        <i class="fas fa-pencil-alt pointer" data-toggle="tooltip" data-placement="top" title="Editar"></i>
                                    </a> 
                                </td>
                                <td class="text-center">
                                    <a class="text-dark" @click="deleteRole(role)">
        ...
        methods: {
            ...
            deleteRole(role){
                swal.fire({
                    ...
                    if (result.value) {
                        this.$Progress.start();
                        axios.delete(`/api/role/${role.id}`).then(()=>{
                            swal.fire(
                                'Eliminado',
