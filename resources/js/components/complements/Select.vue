...
<script type="text/babel">
  import pointerScroll from '../complements/mixins/pointerScroll'
  import typeAheadPointer from '../complements/mixins/typeAheadPointer'
  import ajax from '../complements/mixins/ajax'
