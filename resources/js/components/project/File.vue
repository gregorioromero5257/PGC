<template>
    <div class="row">
        <div class="col-md-12 mb-3">
            <p class="h5 font-weight-bold d-inline-block mt-2 d-lg-none">
                Archivos
            </p>
            <a href="#" class="btn btn-outline-orange float-right font-weight-bold" @click="newModal">
        ...
        <div class="col-md-12" v-if="project.files && project.files.length > 0">
            <ul class="list-group list-group-flush">
                <li class="list-group-item list-group-item-action" v-for="file in project.files" :key="file.id">
                    <div class="media">
                        <i 
                            ...
                            :class="{ 
                                ...
                                'fa-file-alt' : file.type != '.pdf' && file.type != '.doc' && file.type != '.docx' && file.type != '.xls' && file.type != '.xlsx' && file.type != '.csv' && file.type != '.zip' && file.type != '.ppt' && file.type != '.pptx' && file.type != '.pps'
                            }"
                        ></i>
                        ...
                        <div class="align-self-center">
                            <i class="fas fa-file-download mr-3 pointer" @click="downloadFile(file)"></i>
                            <i class="fas fa-trash-alt pointer" @click="deleteFile(file)"></i>
                        </div>
                    </div>
                </li>
            </ul>
    ...
    export default {
        ...
        methods: {
            ...
            addDocument(e){
                ...
                formData.append('project_id', this.form.id);
